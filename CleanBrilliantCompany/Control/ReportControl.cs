...
namespace CleanBrilliantCompany.Control
{
    public class ReportControl
    {
        ...
        public ReportControl(ReportGenerator reportGenerator, IAIService aiService, ReportRepo repo, IDashboardFacade dashboardFacade, IForecastReportDetails forecastFacade)
        {
