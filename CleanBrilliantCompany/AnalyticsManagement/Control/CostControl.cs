public class CostControl
{
        ...
        ICostRepository costRepository)
    {
        ...
        costRepository.LoadDashboards();
    }

    public string GenerateReport()
    {
        var dashboard = costRepository.GetLatestDashboard();
    ...
    public void UpdateDashboard()
    {
        ...
        logger.LogInformation($"✅ Dashboard updated with name: {newDashboard.Name}, GeneratedDate: {newDashboard.GeneratedDate}");
    }
}