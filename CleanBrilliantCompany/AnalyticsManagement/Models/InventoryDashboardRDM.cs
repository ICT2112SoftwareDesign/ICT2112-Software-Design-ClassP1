...
public class InventoryDashboardRDM : Dashboard
{
    ...
    public InventoryDashboardRDM(int id, string name, DateTime requestedStartDate, DateTime requestedEndDate, int validityDuration, DateTime generatedDate, int type)
        : base(id, name, requestedStartDate, requestedEndDate, validityDuration, 2, generatedDate)
    {
        _stockLevel = new Dictionary<int, int>();
        _threshold = new Dictionary<int, int>();
        _replenishmentStatus = new Dictionary<int, bool>();
