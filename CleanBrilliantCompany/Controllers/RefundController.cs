...
namespace CleanBrilliantCompany.Controllers.Refund
{
    ...
    public class RefundController : Controller
    {
        ...
        public RefundController(IRefundQuery refundManagement)
        {
        ...
        public IActionResult Refund()
        {
            ...
            return View("~/Views/Staff/refund.cshtml", refunds);
        }
        ...
        public IActionResult RefundDetails(int id)
        {
            ...
            return View("~/Views/Staff/refund-details.cshtml", refund);
        }
