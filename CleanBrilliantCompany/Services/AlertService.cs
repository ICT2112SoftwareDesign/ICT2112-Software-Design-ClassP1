    ...
    public class AlertService : IAlertService
    {
        ...
        public async Task<Alert?> GenerateAlertForPeriodAsync(int year, int month)
        {
            ...
            try
            {
                ...
                // Ensure data is retrieved before calculating emissions
                await _carbonNotification.RetrieveItemEmission();
                await _carbonNotification.RetrieveOrderEmission();
                decimal actualEmissions = await _carbonNotification.GetTotalEmissionsForMonthAsync(month, year);
